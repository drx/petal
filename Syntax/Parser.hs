...
data HappyAbsSyn 
	...
	| HappyAbsSyn6 (InstructionSequence)
	| HappyAbsSyn7 ([Instruction])
...
action_14 (5) = happyGoto action_12
...
action_17 (14) = happyShift action_2
...
action_21 (5) = happyGoto action_12
...
happyReduction_7 ((HappyAbsSyn4  happy_var_5) `HappyStk`
	...
	happyRest)
	 = HappyAbsSyn6
		 (Seq happy_var_1 happy_var_3 happy_var_5 (nub $ (registers happy_var_3)++(registersv happy_var_5))
	) `HappyStk` happyRest
...
happyReduction_8 ((HappyAbsSyn4  happy_var_6) `HappyStk`
	...
	happyRest)
	 = HappyAbsSyn6
		 (Seq happy_var_1 happy_var_4 happy_var_6 (nub $ (registersv happy_var_6)++(registers happy_var_4))
	) `HappyStk` happyRest
